    ...
    <section>
      <div className='relative'>
        ...
        <div className='absolute inset-0 flex flex-col items-center justify-center space-y-1 z-20 bg-transparent'>
          <p className='font-urbanist text-[#EDF2F7] font-bold text-[3.25rem] leading-10'>Empowering Rural Dreams with </p>
          <p className='font-urbanist text-[#E76F51] font-bold text-[3.25rem]'> Education & Nourishment</p>
